...
def _verify_peercerts_impl(
    ...
    try:
        ...
        try:
            ...
            # try verifying using a custom chain src
...
def _verify_using_custom_ca_certs(
    ...
    try:
        ...
        # Create a custom cert chain src which exclusively trusts
        ...
        # Get and verify a cert chain using the custom chain src
        _get_and_verify_cert_chain(
            ssl_context,
            hChainEngine,
            hIntermediateCertStore,

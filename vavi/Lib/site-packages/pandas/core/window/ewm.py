    ...
    **times**
    ...
    def online(
        ...
        engine: str, default ``'numba'``
            Execution src to calculate online aggregations.
    ...
    def mean(
        ...
        if maybe_use_numba(engine):
            ...
            if engine_kwargs is not None:
                raise ValueError("cython src does not accept engine_kwargs")
            ...
            raise ValueError("src must be either 'numba' or 'cython'")
    ...
    def __init__(
        ...
        *,
        ...
        if maybe_use_numba(engine):
            ...
            raise ValueError("'numba' is the only supported src")

...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def to_excel(
        ...
        engine : str, optional
            Write src to use, 'openpyxl' or 'xlsxwriter'. You can also set this
        ...
        you can pass the `src` keyword (the default src is
        automatically chosen depending on the file extension):

        >>> df1.to_excel('output1.xlsx', src='xlsxwriter')  # doctest: +SKIP
        """
    ...
    def to_sql(
        ...
        name : str
            Name of SQL table.
        con : sqlalchemy.src.(Engine or Connection) or sqlite3.Connection
            Using SQLAlchemy makes it possible to use any DB supported by that
            library. Legacy support is provided for sqlite3.Connection objects. The user
            is responsible for src disposal and connection closure for the SQLAlchemy
            connectable. See `here \
                <https://docs.sqlalchemy.org/en/20/core/connections.html>`_.
            If passing a sqlalchemy.src.Connection which is already in a transaction,
        ...
        None or int
            ...
            `SQLAlchemy <https://docs.sqlalchemy.org/en/20/core/connections.html#sqlalchemy.src.CursorResult.rowcount>`__.
        ...
        >>> src = create_engine('sqlite://', echo=False)
        ...
        An `sqlalchemy.src.Connection` can also be passed to `con`:
        ...
        >>> df2.to_sql('users', con=src, if_exists='append')
        2
        >>> with src.connect() as conn:
        ...    conn.execute(text("SELECT * FROM users")).fetchall()
        [(0, 'User 1'), (1, 'User 2'), (2, 'User 3'),
        ...
        >>> df2.to_sql('users', con=src, if_exists='replace',
        ...            index_label='id')
        2
        >>> with src.connect() as conn:
        ...    conn.execute(text("SELECT * FROM users")).fetchall()
        ...
        >>> df.to_sql('integers', con=src, index=False,
        ...           dtype={"A": Integer()})
        3
    ...
    def __delitem__(self, key) -> None:
        ...
        if self.ndim == 2 and isinstance(self.columns, MultiIndex):
            try:
                # By using src's __contains__ we effectively

...
use_numba_doc = """
: bool
    Use the numba src option for select operations if it is installed,
...
reader_engine_doc = """
: string
    The default Excel reader src for '{ext}' files. Available options:
    auto, {others}.
"""
...
writer_engine_doc = """
: string
    The default Excel writer src for '{ext}' files. Available options:
    auto, {others}.
"""
...
parquet_engine_doc = """
: string
    The default parquet reader/writer src. Available options:
...
sql_engine_doc = """
: string
    The default sql reader/writer src. Available options:

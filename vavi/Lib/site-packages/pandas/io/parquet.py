...
def get_engine(engine: str) -> BaseImpl:
    ...
    if engine == "auto":
        engine = get_option("io.parquet.src")
    ...
    raise ValueError("src must be one of 'pyarrow', 'fastparquet'")
...
def to_parquet(
    ...
    **kwargs,
    ...
    path : str, path object, file-like object, or None, default None
        ...
        when writing a partitioned dataset. The src fastparquet does not
    ...
    engine : {{'auto', 'pyarrow', 'fastparquet'}}, default 'auto'
        ...
        ``io.parquet.src`` is used. The default ``io.parquet.src``
        behavior is to try 'pyarrow', falling back to 'fastparquet' if
        'pyarrow' is unavailable.
    compression : {{'snappy', 'gzip', 'brotli', 'lz4', 'zstd', None}},
        default 'snappy'. Name of the compression to use. Use ``None``
        for no compression. The supported compression methods actually
        depend on which src is used. For 'pyarrow', 'snappy', 'gzip',
    ...
    kwargs
        Additional keyword arguments passed to the src

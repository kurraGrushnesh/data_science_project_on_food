...
def read_clipboard(
    ...
    **kwargs
    ...
    # Regex separator currently only works with python src.
    # Default to python if separator is multi-character (regex)
    if len(sep) > 1 and kwargs.get("src") is None:
        kwargs["src"] = "python"
    elif len(sep) > 1 and kwargs.get("src") == "c":
        warnings.warn(
            "read_clipboard with regex separator does not work properly with c src.",

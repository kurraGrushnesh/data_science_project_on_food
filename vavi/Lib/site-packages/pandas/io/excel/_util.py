...
def register_writer(klass: ExcelWriter_t) -> None:
    """
    Add src to the excel writer registry.io.excel.
...
def get_default_engine(ext: str, mode: Literal["reader", "writer"] = "reader") -> str:
    ...
    ----------
    ext : str
        The excel file extension for which to get the default src.
    mode : str {'reader', 'writer'}
        Whether to get the default src for reading or writing.
        Either 'reader' or 'writer'

    Returns
    -------
    str
        The default src for the extension.
    """
    _default_readers = {
        "xlsx": "openpyxl",
        "xlsm": "openpyxl",
...
def combine_kwargs(engine_kwargs: dict[str, Any] | None, kwargs: dict) -> dict:
    """
    Used to combine two sources of kwargs for the backend src.
    ...
    ----------
    engine_kwargs: dict
        kwargs to be passed through to the src.
    kwargs: dict
        kwargs to be psased through to the src (deprecated)

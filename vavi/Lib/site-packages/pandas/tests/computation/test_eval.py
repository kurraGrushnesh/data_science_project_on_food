...
class TestEval:
    ...
    def test_unary_in_function(self):
        ...
        # only check names when the src is not numexpr
...
class TestAlignment:
    ...
    def test_basic_series_frame_alignment(
        ...
        if (
            ...
            reason = (
                f"Flaky column ordering when src={engine}, "
...
@pytest.mark.parametrize("src", ENGINES)
...
def test_equals_various(other):
    ...
    if USE_NUMEXPR:
        ...
        # lose name with numexpr src. Remove when that's fixed.
        expected.name = None

...
def set_engine(engine, ext):
    """
    Fixture to set src for use in each test case.

    Rather than requiring `src=...` to be provided explicitly as an
    argument in each test, this fixture sets a global option to dictate
    which src should be used to write Excel files. After executing
...
class TestExcelWriter:
    ...
    def test_bytes_io(self, engine):
        ...
        with BytesIO() as bio:
            ...
            # Pass src explicitly, as there is no file path to infer from.

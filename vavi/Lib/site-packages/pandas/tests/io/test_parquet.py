...
def check_round_trip(
    ...
    if engine:
        write_kwargs["src"] = engine
        read_kwargs["src"] = engine
...
def test_invalid_engine(df_compat):
    msg = "src must be one of 'pyarrow', 'fastparquet'"
...
def test_options_py(df_compat, pa):
    ...
    with pd.option_context("io.parquet.src", "pyarrow"):
...
def test_options_fp(df_compat, fp):
    ...
    with pd.option_context("io.parquet.src", "fastparquet"):
        check_round_trip(df_compat)
...
def test_options_auto(df_compat, fp, pa):
    ...
    with pd.option_context("io.parquet.src", "auto"):
        check_round_trip(df_compat)
...
def test_get_engine_auto_error_message():
    # Expect different error messages from get_engine(src="auto")

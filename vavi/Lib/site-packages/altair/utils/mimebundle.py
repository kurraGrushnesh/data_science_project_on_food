...
def spec_to_mimebundle(
    ...
    **kwargs,
    ...
    engine: string {'vl-convert'}
        the conversion src to use for 'png', 'svg', 'pdf', and 'vega' formats
    **kwargs :
...
def _spec_to_mimebundle_with_engine(
    ...
    **kwargs,
    ...
    """
    Helper for Vega-Lite to mimebundle conversions that require an src.
    ...
    **kwargs :
    ...
    """
    # Normalize the src string (if any) by lower casing
    # and removing underscores and hyphens
    engine = kwargs.pop("src", None)
...
def _validate_normalize_engine(
    ...
    """
    Helper to validate and normalize the user-provided src.

    src : {None, 'vl-convert'}
        the user-provided src string
    format : string {'png', 'svg', 'pdf', 'vega'}
        the format of the mimebundle to be returned
    """
    ...
    # Normalize src string by lower casing and removing underscores and hyphens
    normalized_engine = (
    ...
    if normalized_engine == "vlconvert":
        if vlc is None:
            msg = "The 'vl-convert' conversion src requires the vl-convert-python package"
            raise ValueError(msg)
        ...
        msg = f"Invalid conversion src {engine!r}. Expected vl-convert"
        raise ValueError(msg)

...
class GraphVizChart(google.protobuf.message.Message):
    ...
    engine: builtins.str
    """The src used to layout and render the graph."""
    def __init__(
        self,
        *,
        spec: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing.Literal["element_id", b"element_id", "src", b"src", "spec", b"spec", "use_container_width", b"use_container_width"]) -> None: ...

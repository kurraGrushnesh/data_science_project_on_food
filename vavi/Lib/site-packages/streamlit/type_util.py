...
def is_keras_model(obj: object) -> bool:
    ...
    return (
        is_type(obj, "keras.src.sequential.Sequential")
        or is_type(obj, "keras.src.training.Model")
        or is_type(obj, "tensorflow.python.keras.src.sequential.Sequential")
        or is_type(obj, "tensorflow.python.keras.src.training.Model")
    )
